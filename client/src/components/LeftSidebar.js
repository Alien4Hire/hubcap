    ...
    return (
        <React.Fragment>
            ...
            {!hideUserProfile && (
                <div className="leftbar-user">
                    <Link to="/">
                        ...
                        <span className="leftbar-user-name">Jason Maynard</span>
                    </Link>
                </div>
            )}
            ...
            <div className="help-box text-white text-center">
                ...
                <p className="mb-3">Upgrade to plan access unlimited stock data</p>
                <button className="btn btn-outline-light btn-sm">Unlimited Access</button>
            </div>
