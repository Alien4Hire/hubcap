    ...
    content: (
      <Card className=" card-testimonial card-plain">
        ...
        <CardBody>
          ...
          "I'm newer to trading... and was having alot of trouble 
          getting started, but after 6 months of trading with Hubcap my account size has nearly trippled!"
          </h5>
          <CardFooter>
  ...
  },
  {
    content: (
      <Card className=" card-testimonial card-plain">
        ...
        <CardBody>
          <h5 className=" card-description">
          "Tools look amazing, and figuring out how to use them was so easy!"
          </h5>
          <CardFooter>
  ...
  },
  {
    content: (
      <Card className=" card-testimonial card-plain">
        ...
        <CardBody>
          <h5 className=" card-description">
          "Love it. Use it everyday to run my trading strategy."
          </h5>
          <CardFooter>
        ...
        <Container fluid>
          <Row>
            <Col className="ml-auto mr-auto text-center" md="8">
              <h2 className="title">Trusted by 9,000+ People</h2>
              <h5 className="description">
                Our software was build by traders and developers around the world to give you the best trading experience.
                Used by <b>9,000+ traders</b> in over{" "}
                <b>1,400,00 successful trades</b>. This is what some of them think:
              </h5>
            </Col>
          </Row>
          <Row>
