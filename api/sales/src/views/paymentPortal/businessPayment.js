        ...
        <Container>
          <Row>
            <div className="title text-center">
              <h3 className="title">
                Ready to grab access to these powerful tools?
              </h3>
              <p className="description">
                You have <b>Unlimited Access</b> and <b>Premium Support</b> on
                each trade search. You also have <b>72 hours</b> to request a
                ...
                <Col md="6">
                  <Card className="card-pricing">
                    <CardBody>
                      ...
                      <CardTitle tag="h3">$79.99</CardTitle>
                      <p>/Monthly</p>
                      <p className="card-description">
                        For individual traders. Trading your personal account,
                        or for a prop firm, you will have access to the Tools
                ...
                <Col md="6">
                  <Card className="card-pricing">
                    <CardBody>
                      ...
                      <CardTitle tag="h3">$799.99</CardTitle>
                      <p>/Yearly</p>
                      <p className="card-description">
                        Get 2 Months free when you purchase an entire years
                        subscription.
                      </p>
                      <CardFooter>
                        <Button
          ...
          <div className="title text-center">
            ...
            <Button
              ...
              color="facebook"
              id="facebook"
              href="https://www.facebook.com/Hubcap-Technologies-103951614784210"
            >
