...
function ColorNavbar() {
  ...
  const [LogoImg, setLogoImg] = React.useState(require("../../assets/img/hubcap.png"));
  React.useEffect(() => {
    ...
    const updateNavbarColor = () => {
      if (
        ...
        setNavbarColor("")
        setLogoImg(require("../../assets/img/hubcap-black.png"))
      } else if (
        document.documentElement.scrollTop < 500 ||
        document.body.scrollTop < 500
      ) {
        setNavbarColor("navbar-transparent")
        setLogoImg(require("../../assets/img/hubcap.png"))
      }
    };
        ...
        <Container>
          <div className="navbar-translate">
            <NavbarBrand id="navbar-brand" to="/" tag={Link}>
              <Image src={LogoImg} className='logo-dis' alt=''/>
            </NavbarBrand>
